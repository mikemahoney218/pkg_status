...
```{r}
valueBox(statuses[["ok"]], color = "success")
```

### Notes

```{r}
valueBox(statuses[["note"]], color = "info")
```

### Warnings

```{r}
valueBox(statuses[["warn"]], color = "warning")
```

### Errors

```{r}
valueBox(statuses[["error"]], color = "danger")
```

### Failures

```{r}
valueBox(statuses[["fail"]], color = "danger")
```
